...
/*   Updated: 2018/11/14 13:13:57 by lguiller         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			init_button(t_env *env)
{
	...
	rect = create_rect(map_to_win(38), map_to_win(18), dim2, dim2);
	env->buttons[TP_START] = create_button(rect, TP_S_COL, BLACK, NULL);
	rect = create_rect(map_to_win(41), map_to_win(18), dim2, dim2);
	env->buttons[TP_END] = create_button(rect, TP_E_COL, BLACK, NULL);
	rect = create_rect(map_to_win(44), map_to_win(18), dim2, dim2);
	env->buttons[B_START] = create_button(rect, START_COL, BLACK, NULL);
	rect = create_rect(map_to_win(38), map_to_win(14), dim2, dim2);
	env->buttons[COLISION] = create_button(rect, BLACK, BLACK, NULL);
	rect = create_rect(map_to_win(44), map_to_win(14), dim2, dim2);
	env->buttons[NO_COLISION] = create_button(rect, BLACK, BLACK, NULL);
	rect = create_rect(map_to_win(41), map_to_win(20), dim2, dim2);
	env->buttons[B_ERASER] = create_button(rect, BLACK, BLACK,
		env->text.eraser);
	rect = create_rect(map_to_win(36) + 2, map_to_win(0) + 2, dim1, dim1);
	env->buttons[WOOD] = create_button(rect, BLACK, BLACK, env->text.t_a);
	rect = create_rect(map_to_win(42) + 2, map_to_win(0) + 2, dim1, dim1);
	env->buttons[METAL] = create_button(rect, BLACK, BLACK, env->text.t_b);
	rect = create_rect(map_to_win(36) + 2, map_to_win(6) + 2, dim1, dim1);
	env->buttons[STONE] = create_button(rect, BLACK, BLACK, env->text.t_c);
	rect = create_rect(map_to_win(42) + 2, map_to_win(6) + 2, dim1, dim1);
